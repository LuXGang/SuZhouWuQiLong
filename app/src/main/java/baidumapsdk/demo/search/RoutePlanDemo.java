...
public class RoutePlanDemo extends Activity implements BaiduMap.OnMapClickListener,
    ...
    public void searchButtonProcess(View v) {
        ...
        PlanNode stNode = PlanNode.withCityNameAndPlaceName("苏州", editSt.getText().toString());
        PlanNode enNode = PlanNode.withCityNameAndPlaceName("苏州", editEn.getText().toString());
